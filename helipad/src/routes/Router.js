...
const ContainerContent = lazy(() => import('../pages/Container/Container'));
...
const Router = () => {
  return (
    <Suspense fallback={<BusyIndicator active />}>
      <Switch>
        <Redirect path={ROUTES.HOME} exact to={ROUTES.CONTAINER} />
        ...
        <Route path={ROUTES.CONTAINER} component={ContainerContent} />
